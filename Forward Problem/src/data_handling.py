...
class Dataloader():
    ...
    def __init__(self, configurations, NX, NY, t0_index, time_steps, n_time_steps, base_path, file_name_conv, train_size, batch_size, seed, rand, device, spacing = 0, print = False):
    ...
    def preprocess(self):
        ...
        for k in range(self.n_time_steps):
            ...
            input = U[:, train_range[0] : train_range[0] + 1,:,:,:]
